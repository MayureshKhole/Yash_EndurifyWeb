...
import { Nav, NavLink, NavbarContainer, Span, NavLogo, NavItems, ToggleButton,GitHubButton, ButtonContainer, MobileIcon, MobileMenu, MobileNavLogo, MobileLink } from './NavbarStyledComponent';
    ...
    <Nav>
      <NavbarContainer>
        ...
        <NavItems>
          ...
          <NavLink href={Bio.github} target="_blank">Blogs</NavLink>
        </NavItems>
        <ButtonContainer>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <MobileLink href='#' onClick={() => setIsOpen(!isOpen)}>Blogs</MobileLink>
